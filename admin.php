...
<body>
            ...
            <div class="tabcontent p-2" id="registration">
                <div class="row px-5 py-3" style="text-align: center;">
                    ...
                    <div class="col">
                        ...
                        <?php
                        $sql = "SELECT `registration_btn_status` FROM `index_page`;";
                        $stmt = $conn->prepare($sql);

                        if (!$stmt) {
                            // Handle error if preparation fails
                            ?>
                            Error With Registration. Please Try Later.
                            <?php
                        } else {
                            $stmt->execute();
                            ...
                            // Use bind_result to bind the result to a variable
                            $stmt->bind_result($registrationBtnStatus);

                            // Fetch the result
                            $stmt->fetch();
                            $stmt->close();

                            if ($registrationBtnStatus == "closed") {
                                $disabled = 'disabled';
                            } else {
                                $disabled;
                            }
                            ...
                            <button id="registration-btn" type="button" class="btn btn-primary" data-bs-toggle="modal"
                                ...
                                REGISTRATION
                                <?php echo $registrationBtnStatus ?>
                            </button>
                            <?php
                        }
                        ?>
                        ...
                        <div class="registration-input">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" data-value="open">Open</a></li>
                                    <li><a class="dropdown-item" data-value="closed">Closed</a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="row py-3 px-5">
        ...
        <div class="col-4"><img src="images/parkmap.jpg" class="img-fluid" style="width: 100%; height:auto" alt="...">
        </div>
    </div>
    </div>
    <!--news-->
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="col">
                    <div class="card shadow-sm">
                        <div class="row">
                            <div class="col-6 m-0 p-0"><img src="images/bereferee.jpg" style="width: 100%; height:auto"
                                    alt="Soccer Reveree"></div>
                            <div class="col-6 m-0 p-0"> <img src="images/asstcoach.png" style="width: 100%; height:auto"
                                    alt="Soccer coach"></div>
                        </div>
                        <div class="card-body">
                            <h5 class="card-text"><b>BE A COACH OR ASSISTANT REFEREE</b></h5>
                            <p>Complete online application for Team Official <br>contact Club Manager: Bev Suggett
                                clubmanager@simcoesoccer.ca<br>
                                If you are interested in becoming an Official (Ref) complete online Official application
                                <br>contact Ref Coordinator: Joe Estrela joe.estrela@hotmail.com
                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="/officials.html"><button type="button"
                                            class="btn btn-sm btn-outline-secondary">View Information</button></a>
                                </div>
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <div class="container-fluid"> <img src="images/balltrophy.jpg" style="width:100%; height:auto;"
                                alt=""></div>
                        <div class="card-body">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <p class="card-text">SDYSC RYAN CATTRYSSE MEMORIAL BURSARY AWARD
                                ...
                                <br>Michelle Millson Vice President presented a cheque for $500 to Natalie Suprun for
                                her submission for the 2023.
                                <br><small>BURSARY CLOSED UNTIL MAY 2024</small>
                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="/ryanaward.html"> <button type="button"
    ...
    <div class="row p-3">
        <div class="col-lg-6 col-sm-12">
            <div class="container-fluid" style="text-align: center; width:90%; height:auto"><a href="/ryanaward.html"
                    style="width:70%"><img src="images/bursary.jpg"></a><br>
                <p style="text-align: center;">Bursary closed until the 2024 outdoor season</p>
            </div>
        </div>
        <div class="col-lg-6 col-sm-12" id="indoor">
            <div class="container-fluid" style="text-align: center; width:90%; height:auto"><img
                    src="images/conveeners.jpg" style="width:80%"></div>
        </div>
    </div>
    <!--indoor -->
    <div class="row p-3 mx-5">
        ...
        <div class="indoorsponsor bg-white px-4">
            <div class="row p-3">
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/timslogo.jpg" alt="tims"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/lions.jpg" alt="lions"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/victor.jpg" alt="victor pools"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/mitandroby.jpg" alt="Mit and roby"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/NACL.jpg" alt="NACL"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/brianlogo.jpg" alt="Brians Handyman"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/barrel.jpg" alt="Barrel"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/toyota.jpg" alt="Toyota"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/jarja.jpg" alt="Jarja"
                        style="width: 100%;"></div>
                <div class="sponpic p-2" style="width: 20%;"><img src="sponsors/TnT.jpg" alt="Tacos and tequila"
                        style="width: 100%;"></div>
            </div>
        </div>
