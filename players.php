...
<body>
  ...
  <div style="text-align: center; margin-top: 1%;">
    ...
    <div class="container-fluid px-2">
      <h5>The year of birth determines what age group your child will play in dates start January 1st to December 31st
        of year of birth.</h5>
      <ul style="list-style-type: none;">
        <li>Youngest players start at 4 years old can play in <strong>LTPD</strong> (Long Term Player Development) until
          player reaches 9 years old after which they move into Youth Soccer at age of 10 years and older. </li>
      ...
      <div class="container-fluid">
        <div class="alert alert-primary p-2 mx-1">
          ...
          <h6 style="text-align: center;">All our players 9 or under play <b>LTPD</b>
            ...
            <h6>Players once they reach 11 years of age or older, play 11 v 11 and play either in a boys or girls
              division
            </h6>
        </div>
      </div>
      <div class="container-fluid px-1">
        <div class="row">
          ...
          <div class="col-sm-12 col-lg-6 p-4">
            <div class="col">
              <h3>YOUR COACH</h3>
              <p style="text-align: left; padding: 0% 5%;">On your first day at the field you will pick up your kit and
                meet the coach and teammates.
                Make sure you get a chance to talk with the coach and get to know him. If you can help out at practice
                or games let him know. </p>
              <img src="images/coachessquare.jpg"
                   style="width: 50%; padding: 5%;">
              <p style="text-align: left;">Also please make sure that team members are on time and ready to go with all
                of the necessary kit. Remember our staff is volunteer and deserve our respect at all times. We are
                dedicated to keeping every one safe and happy.</p>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12 col-lg-6 px-4">
            ...
            <p small
               style="text-align: left;">Learn about the Concussion Awareness Resources that amateur athletes, parents,
              coaches, team trainers and officials are required to review.
            </p>
          </div>
          <div class="col-sm-12 col-lg-6 px-4"
