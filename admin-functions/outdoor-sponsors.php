...
$image = $_FILES["outdoor_sponsor_image"];
$name = $_POST["outdoor_sponsor_name"];
...
if (!getimagesize($_FILES["outdoor_sponsor_image"]["tmp_name"])) {
...
if (!move_uploaded_file($_FILES["outdoor_sponsor_image"]["tmp_name"], $targetFile)) {
...
echo $image;
    ...
    $sql = "INSERT INTO `outdoor_sponsors` (`name`, `image`) VALUES (?, ?);";
