...
<head>
  ...
  <link href="<?php echo BASE_URL ?>css/selection.css"
        rel="stylesheet">
          ...
          <div class="container-fluid"
            ...
            <h6 style="text-align: center; padding: 0% 10%;">All parents must sign a Concussion Code of Conduct form to
              ...
              <div style="text-align: center;">
                ...
                <a href="https://files.ontario.ca/mhstci-rowans-law-codes-of-conduct-20191120-coaches-en.pdf">
                  Click here to get the form
                </a>

                <form method="post"
                      action="admin-functions/update-code-of-conduct.php"
                      enctype="multipart/form-data">
                  <h4 class="text-start">Select A New Code Of Conduct Form</h4>
                  <input type="file"
                         class="form-control"
                  ...
                  <button class="btn btn-primary m-3">Update Form</button>
                </form>
